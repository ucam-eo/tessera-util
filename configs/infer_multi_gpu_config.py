...
config.update({
    # Data path
    # "tile_path": "data/downstream/austrian_crop",
    "tile_path": "data/downstream/austrian_crop/whole_year_data/33UXP",
    # "tile_path": "data/downstream/clement_agb/22MCU",
    
    # Model checkpoint
    # "checkpoint_path": "checkpoints/ssl/best_model_fsdp_20250417_101636.pt",
    "checkpoint_path": "checkpoints/ssl/best_model_fsdp_20250427_084307.pt",
    
    # Inference parameters
    "repeat_times": 1,
    "min_valid_timesteps": 0,
    "batch_size": 16384,  # Increased for better GPU utilization
    # "output_npy": "data/representation/clement_agb/22MCU/representations_fsdp_20250417_101636.npy",
    "output_npy": "data/representation/austrian_crop/representations_fsdp_20250427_084307_repreat_1.npy",

...
if __name__ == "__main__":
    npy_path = "/home/zf281/rds/rds-airr-p3-w8D3JcRiKZQ/austrian_crop_v1.0_pipeline/stitched_representation.npy"  # Change to the actual npy file path
    ref_tiff_path = "/home/zf281/rds/rds-airr-p3-w8D3JcRiKZQ/austrian_crop_v1.0_pipeline/roi.tif"  # Change to the actual reference tiff file path
    out_dir = "/home/zf281/rds/rds-airr-p3-w8D3JcRiKZQ/austrian_crop_v1.0_pipeline/"  # Change to the actual output directory

...
if __name__ == "__main__":
    npy_path = "data/representation/austrian_crop_representation_multi_node.npy"         # 修改为实际 npy 文件路径
    ref_tiff_path = "data/representation/dual_transformer_repr_33UXP.tif"      # 修改为实际参考 tiff 文件路径
    out_dir = "data/representation"         # 修改为实际输出目录

...
if __name__ == "__main__":
    input_dir = r"/scratch/zf281/btfm_representation/austrian_crop/efm_v1.0"
    roi_path = r"/scratch/zf281/btfm_representation/austrian_crop/mpc_pipeline_fsdp_20250408_101211.tif"  # 注意这里已修正为tiff
    output_path = r"/scratch/zf281/btfm_representation/austrian_crop/austrian_crop_efm_v1.0.tif"
